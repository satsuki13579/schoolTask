...
//        var gui = new dat.GUI();
        ...
        gui.add(this.controls, 'bevelThickness',-200,200).onChange((e:number)=>{
            this.controls.bevelThickness = e;
            this.scene.remove(this.shape1);
            this.drawExtrude();
        });
        gui.add(this.controls, 'amount', -200, 200).onChange((e: number) => {
            this.controls.amount = e;
            this.scene.remove(this.shape1);
            this.drawExtrude();
        });
        gui.add(this.controls, 'bevelSize', -10, 10).onChange((e: number) => {
